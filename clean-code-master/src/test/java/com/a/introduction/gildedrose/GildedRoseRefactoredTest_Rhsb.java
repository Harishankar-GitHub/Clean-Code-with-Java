...
public class GildedRoseRefactoredTest_Rhsb {
	...
	public void assertItem(Item expected, Item actual) {
		assertEquals(expected.name, actual.name);
		assertEquals(expected.sellIn, actual.sellIn);
		assertEquals(expected.quality, actual.quality);
	}

	public GildedRose createGildedRoseWithOneItem(String itemType, int sellIn, int quality) {
