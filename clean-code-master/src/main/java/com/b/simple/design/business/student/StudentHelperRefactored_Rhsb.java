...
public class StudentHelperRefactored_Rhsb {
	...
	*/
	public boolean isGradeB(int marks, boolean isMaths) {
		...
		int extraLimit = isMaths ? EXTRA_LIMIT_MATHS : 0;
    ...
    */
	...
	public boolean isGood(int marks, boolean isMaths) {
	...
	public boolean isNotGood(int marks, boolean isMaths) {
